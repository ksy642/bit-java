...
//		basicSearc();
	...
	private static void arrayCopyEx() {
		char src[] = "Java Programming".toCharArray(); // char배열로...
	...
	// 배열의 정리
	// 기본 정렬은 오름차순 (Ascending :  작은값 ->  큰 값 순)
...
//		System.out.println("Python의 인덱스 : " + index2);
	...
	private static void  customSearch() {
		...
		int index = Arrays.binarySearch(members, 
				new Member("장길산")); 
		// 사용자 정의 객체의 검색시에는 객체를 넘겨주어 해당 객체와
		// 같은지를 비교해줘야 한다.

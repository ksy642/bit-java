...
public class MainThread {
	...
	public static void main(String[] args) {
		...
		// Thread 실행 우선순위 : 자윈이 부족할 경우 먼저 수행해야 할 쓰레드의 순위를 결정한다.
		// 일반적으로 1(최소) ~ 10(최대) 까지 우선순위는 5(NORM_PRIORITY)
		thread1.setPriority(Thread.MIN_PRIORITY); // 상수 : 1  (최소)
		thread2.setPriority(Thread.MAX_PRIORITY); // 상수 : 10 (최대)

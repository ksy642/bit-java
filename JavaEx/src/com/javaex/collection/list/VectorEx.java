...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		for (int i=1; i<=10; i++) {
			v.addElement(i);
			// v.addElement(Integer.valueOf(i)); 이것과 같다.
		}
		...
		v.insertElementAt(5, 7); // 5라는 객체를 7번째 인덱스에 추가
		// 당연히 시작은 0번째로 침 숫자가 1로 나온다한들
		System.out.printf("Vector : " + v);
...
//		v2.addElement(Boolean.valueOf(true)); // 불린은 Number의 자식이 아니다!
